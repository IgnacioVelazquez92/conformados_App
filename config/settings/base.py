...
EVIDENCIA_RATE_LIMIT_COUNT = int(os.getenv("EVIDENCIA_RATE_LIMIT_COUNT", "3"))
EVIDENCIA_RATE_LIMIT_WINDOW_SECONDS = int(os.getenv("EVIDENCIA_RATE_LIMIT_WINDOW_SECONDS", "600"))
