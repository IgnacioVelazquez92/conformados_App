...
urlpatterns = [
    ...
    path("accounts/cambiar-clave/", views.cambiar_clave, name="cambiar-clave"),
    ...
    path("panel/empresas/<slug:empresa_slug>/hojas/<uuid:oid>/anular/", views.anular_hoja, name="panel-anular-hoja-empresa"),
    path("panel/hojas/<uuid:oid>/anular/", views.anular_hoja, name="panel-anular-hoja"),
