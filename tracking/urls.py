...
urlpatterns = [
    ...
    path("panel/usuarios/importar/", views.panel_importar_usuarios, name="panel-importar-usuarios"),
    path("panel/usuarios/plantilla/", views.panel_descargar_plantilla_usuarios, name="panel-plantilla-usuarios"),
